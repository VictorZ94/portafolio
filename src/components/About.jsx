    ...
    <section className="my-5 text-center" id={convertStringToSlug(t("nav.about"))}>
      <Container className='shadow p-5'>
        ...
        <div className="description px-2 pt-4 px-md-5">
          <p>I'm a React developer, with experience turning ideas into functional web products. Moreover, I have knowledge in Back-end with Python and Django, although I am specializing in Front-end.</p>
